      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 flex flex-col mr-10 p-2 mb-6">
          ...
          <div className="flex gap-6 mb-6">
            {/* Mood Section */}
            <div className="bg-white border-2 border-black rounded-xl p-7 flex-1 shadow-[4px_4px_0_#000]
                            flex flex-col gap-5">
            ...
            {/* Color Palette Section */}
              <div className="bg-white border-2 border-black rounded-xl p-7 flex-1 shadow-[4px_4px_0_#000]
                              flex flex-col gap-5">
                <div className="flex items-center justify-center gap-4">
                  <div className="w-16 h-16 rounded-full border-3 border-black shadow-[3px_3px_0_#000] bg-korofu-aqua">
                  </div>
                  <div className="flex-1 font-semibold text-2xl min-h-15 flex items-center">
          ...
          <div className="bg-korofu-light-yellow border-2 border-black flex gap-15
            ...
            <div className="flex w-[35%] flex-col justify-between">
              ...
              <div className="flex flex-col gap-3">
                <button className="large-button bg-korofu-yellow w-full">Choose my own food!</button>
                <button className="large-button bg-korofu-aqua w-full">Quick pick for me!</button>
              </div>
            </div>
          ...
          <div className="bg-korofu-blue border-2 border-black flex gap-15
                          rounded-xl p-8 mb-6 shadow-[4px_4px_0_#000]">
            <div className="flex w-[35%] flex-col justify-between">
              <p className="text-3xl font-semibold">
          ...
          <div className="bg-korofu-green border-2 border-black flex gap-15
                          rounded-xl p-8 mb-6 shadow-[4px_4px_0_#000]">
            <div className="flex-1 flex flex-col gap-5">
            ...
            <div className="flex w-[35%] flex-col justify-between">
              ...
              <div className="flex flex-col gap-3">
                <button className="large-button bg-korofu-pink w-full">Any more new restaurants?</button>
                <button className="large-button bg-korofu-orange w-full">I’d prefer my familiars.</button>
              </div>
            </div>
          </div>
        </main>
