    ...
    <div className="min-h-screen">
      ...
      <div className="min-h-screen flex pl-10 mt-5">
        ...
        <main className="flex-1 p-6 rounded-3xl">
          <h1 className="text-3xl font-extrabold text-[#21120D] mb-8">Choose Your Food</h1>
          
          <div className="bg-white border-2 border-black rounded-3xl p-6 shadow-[8px_8px_0_#000]">
            <p className="text-lg mb-4">Select your preferred food options</p>
            {/* Add your food selection content here */}
          </div>
        </main>
      </div>
    </div>
